...
const startDateFilter = new Date(new Date().setMonth(new Date().getMonth() - 1)).toISOString().substring(0,10);
    ...
    return (
        ...
        >
            <div
                className={
                    style[
                        "history-transaction--history-content--filter-content"
                    ]
                }
            >
                <label
                    className={style["history-transaction--form-element--wrap"]}
                >
                    <span>Start Date</span>
                    <input
                        className={
                            style["history-transaction--form-element--input"]
                        }
                        type="date"
                        name="startDate"
            ...
            <div
                className={
                    style[
                        "history-transaction--history-content--direct-content"
                    ]
                }
            >
                <Link
                    className={
                        style[
                            "history-transaction--history-content--direct-button"
                        ]
                    }
                    href={direct.insert}
                >
