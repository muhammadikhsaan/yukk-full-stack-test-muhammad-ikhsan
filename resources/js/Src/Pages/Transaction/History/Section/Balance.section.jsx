...
const BalanceSection = ({ calculate, balance }) => {
    return (
        <div className={style["history-transaction--balance-content--wrap"]}>
            <div
                className={
                    style["history-transaction--balance-content--second-wrap"]
                }
            >
                <h1
                    className={
                        style["history-transaction--balance-content--title"]
                    }
                >
                    Balances
                </h1>
                <div
                    className={
                        style[
                            "history-transaction--balance-content--box-content"
                        ]
                    }
                >
                    <h1
                        className={
                            style["history-transaction--balance-content--label"]
                        }
                    >
                        Amount
                    </h1>
                    <p
                        className={
                            style["history-transaction--balance-content--value"]
                        }
                    >
                        <span
                            className={
                                style[
                                    "history-transaction--balance-content--unit"
                                ]
                            }
                        >
                            IDR
